...
This attack will force them to run as admin using bombardment (continous loops). The only way out of this loop is allowing the application to execute as shown in the video below.
